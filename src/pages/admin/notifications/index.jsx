...
const NotificationCreator = () => {
	...
	const deleteWideNoti = event => {
		fetch('http://localhost:8080/notification?action=delete-public-noti&id=' + wideNotificationDetail?.id, {
			method: 'GET',
			headers: {
	...
	useEffect(() => {
		...
		fetch('http://localhost:8080/notification?action=list-private-noti-from-admin', {
			method: 'GET',
			headers: {
				'Content-type': 'application/json; charset=UTF-8'
			}
