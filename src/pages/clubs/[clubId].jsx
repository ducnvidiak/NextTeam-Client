...
function ClubPage() {
  return (
    <Container maxWidth='lg' sx={{ marginTop: 20 }}>
      <Card>
        <img
          src='https://scontent.fdad3-5.fna.fbcdn.net/v/t39.30808-6/376251256_791462792989198_2157449619517553064_n.jpg?_nc_cat=102&ccb=1-7&_nc_sid=52f669&_nc_ohc=ocIWdlrWCeAAX_G3krL&_nc_ht=scontent.fdad3-5.fna&oh=00_AfCxGTcLlejCtePQLrnffyY1M3y4syZlxiibhtAEtEuMww&oe=650E7564'
          alt=''
          style={{
            width: '100%',
            objectFit: 'cover',
        ...
        <CardContent sx={{ display: 'flex', flexDirection: 'row', gap: 4 }}>
          <Card sx={{ height: '140px', width: '140px' }}>
            <img
              src='https://scontent.fdad3-1.fna.fbcdn.net/v/t39.30808-6/273767560_1006324376624523_56798993667723437_n.jpg?_nc_cat=103&ccb=1-7&_nc_sid=a2f6c7&_nc_ohc=_Im1ev6PhHYAX9M4gFE&_nc_ht=scontent.fdad3-1.fna&oh=00_AfDSSeX_zs2ovdorCbGPp_7oIoZ8Cb8DsQYzZekf8oSglw&oe=650F1AD5'
              alt=''
              width={'100%'}
              height={'100%'}
              objectFit={'cover'}
